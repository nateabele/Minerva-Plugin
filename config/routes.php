...
*/
Router::connect('/', array('controller' => 'minerva.pages', 'action' => 'view', 'home'));
// and this is for the other static pages
Router::connect('/page/{:args}', array('controller' => 'minerva.pages', 'action' => 'view'));

Router::connect('/admin/{:args}', array('admin' => true, 'controller' => 'minerva.pages', 'action' => 'view', 'home'));
...
*/
// "view" is static
Router::connect('/page/{:url}', array('controller' => 'minerva.pages', 'action' => 'view'));
// "read" is from the database
Router::connect('/pages/read/{:url}', array('controller' => 'minerva.pages', 'action' => 'read'));
...
*/
Router::connect('/register', array('controller' => 'minerva.users', 'action' => 'register'));
Router::connect('/login', array('controller' => 'minerva.users', 'action' => 'login'));
Router::connect('/logout', array('controller' => 'minerva.users', 'action' => 'logout'));
